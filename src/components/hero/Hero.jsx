        ...
        <div className="hero">
            <div className="wrapper">
                <motion.div className="textContainer" variants={textVariants} initial="initial" animate="animate">
                    <motion.h2 variants={textVariants} >Rakesh Bora</motion.h2>
                    <motion.h1 variants={textVariants}>Web Developer and Mobile Developer</motion.h1>
            ...
            <motion.div className="slidingTextContainer" variants={silderVariants} initial="initial" animate="animate">
                A web developer is responsible for the design and functionality of websites.
            </motion.div>
        </div>
    )
}
