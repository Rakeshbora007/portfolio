...
const Contact = () => {
    ...
    const sendEmail = (e) => {
        ...
        emailjs
            .sendForm('service_9xh2a3s', 'template_x3xblya', form.current, {
                publicKey: 'IDXrYyJQuharW70G0',
            })
            .then(
                () => {
                    console.log('SUCCESS!');
    ...
    return (
        <div className='contact'>
            <motion.div className="textCotainer" variants={variants} initial="initial" whileInView="animate">
                ...
                <motion.div variants={variants} className="item">
                    <h2>Address</h2>
                    <span>hello street kashipur</span>
                </motion.div>
                <motion.div variants={variants} className="item">
                    <h2>Phone</h2>
                    <span>91+ 2376432748</span>
                </motion.div>
            </motion.div>
            <div className="formContainer">
                ...
                >
                    <svg height="450px" width="450px" fill="none" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
			...
			c2.773,1.643,4.651,4.395,5.141,7.552C390.507,360.448,389.568,363.648,387.435,366.037z"/>
                ...
                >
                    ...
                    <textarea placeholder='Message' rows="12" name='message'></textarea>
